...
class App extends Component {
  ...
  constructor() {
    super();
    this.state = {lista : [{nome:'Lenny',email:'lennybarella@hotmail.com',senha:'123456'}]};
  }
        ...
        <div id="menu">
            <div className="pure-menu">
                ...
                <ul className="pure-menu-list">
                    <li className="pure-menu-item"><a href="#" className="pure-menu-link">Página Inicial</a></li>
